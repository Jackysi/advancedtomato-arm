...
struct nvram_tuple r8000_params[] = {
                                ...
                                { "0:regrev", "86", 0 },
                                { "0:rxgainerr5ga0", "63,63,63,-9", 0 },
                                { "0:rxgainerr5ga1", "31,31,31,-2", 0 },
                                { "0:rxgainerr5ga2", "31,31,31,-5", 0 },
                                { "0:pdoffset40ma0", "0", 0 },
                                { "0:mcsbw405ghpo", "0x98658640", 0 },
                                { "0:pdoffset40ma1", "0", 0 },
                                { "0:pdoffset40ma2", "0", 0 },
                                { "0:sromrev", "11", 0 },
                                ...
                                { "0:rxgains5gtrelnabypa2", "1", 0 },
                                { "0:antswitch", "0", 0 },
                                { "0:mcsbw205gmpo", "0x98658640", 0 },
                                { "0:txchain", "7", 0 },
                                { "0:phycal_tempdelta", "15", 0 },
                                { "0:boardflags2", "0x2", 0 },
                                { "0:boardflags3", "0x1", 0 },
                                { "0:pa5ga0", "0xff4c,0x18df,0xfd12,0xff52,0x195d,0xfd11,0xff49,0x1a47,0xfcdc,0xff40,0x1b48,0xfccb", 0 },
                                { "0:pa5ga1", "0xff5c,0x19ba,0xfd12,0xff3e,0x1932,0xfcf5,0xff4d,0x1a9f,0xfcdd,0xff41,0x1cb1,0xfcab", 0 },
                                { "0:rxgains5gtrisoa0", "6", 0 },
                                { "0:pa5ga2", "0xff29,0x16c3,0xfd33,0xff4f,0x1b3d,0xfcd8,0xff4a,0x1fde,0xfc5f,0xff40,0x1c41,0xfca1", 0 },
                                ...
                                { "0:aga0", "0x0", 0 },
                                { "0:aga1", "0x0", 0 },
                                { "0:mcsbw805gmpo", "0x98658640", 0 },
                                { "0:aga2", "0x0", 0 },
                                { "0:mcsbw205ghpo", "0x98658640", 0 },
                                { "1:venid", "0x14e4", 0 },
                                { "1:watchdog", "3000", 0 },
                                ...
                                { "1:rawtempsense", "0x1ff", 0 },
                                { "1:femctrl", "6", 0 },
                                { "1:dot11agofdmhrbw202gpo", "0x8ECA", 0 },
                                { "1:papdcap2g", "0", 0 },
                                { "1:pa2ga0", "0xff40,0x1b2a,0xfcd0", 0 },
                                { "1:pa2ga1", "0xff45,0x1b83,0xfcd2", 0 },
                                { "1:mcsbw402gpo", "0x98658640", 0 },
                                { "1:pa2ga2", "0xff3a,0x1b35,0xfcc2", 0 },
                                { "1:dot11agduplrpo", "0", 0 },
                                { "1:ccode", "Q2", 0 },
                                { "1:mcsbw202gpo", "0x98658640", 0 },
                                { "1:ofdmlrbw202gpo", "0x0", 0 },
                                { "1:venvid", "0x14e4", 0 },
                                { "1:devid", "0x43BB", 0 },
                                { "1:rxgains2gtrelnabypa0", "1", 0 },
                                { "1:rxgains2gtrelnabypa1", "1", 0 },
                                ...
                                { "2:mcsbw405glpo", "0x87657531", 0 },
                                { "2:devid", "0x43BC", 0 },
                                { "2:mcsbw405ghpo", "0x87657531", 0 },
                                { "2:rxgains5ghtrisoa0", "6", 0 },
                                { "2:rxgains5ghtrisoa1", "6", 0 },
                                { "2:rxgains5ghtrisoa2", "6", 0 },
                                { "2:tempthresh", "120", 0 },
                                { "2:rxgainerr5ga0", "-9,63,63,63", 0 },
                                { "2:rxgainerr5ga1", "-4,31,31,31", 0 },
                                { "2:rxgainerr5ga2", "-5,31,31,31", 0 },
                                { "2:pdoffset40ma0", "0x5444", 0 },
                                { "2:pdoffset40ma1", "0x5444", 0 },
                                { "2:pdoffset40ma2", "0x5344", 0 },
                                { "2:pa5ga0", "0xff25,0x166D,0xfd37,0xff27,0x16d0,0xfd20,0xFF33,0x1A22,0xFCD6,0xFF32,0x19FC,0xFCDD", 0 },
                                { "2:pa5ga1", "0xff28,0x1619,0xfd3c,0xff31,0x179f,0xfd1b,0xFF2F,0x19B3,0xFCE2,0xFF2E,0x19EB,0xFCDA", 0 },
                                { "2:pa5ga2", "0xff29,0x15c3,0xfd4e,0xff2a,0x1777,0xfd16,0xFF31,0x1A12,0xFCD7,0xFF31,0x19FE,0xFCDD", 0 },
                                { "2:txchain", "7", 0 },
                                { "2:dot11agduphrpo", "0x4444", 0 },
                                { "2:epagain5g", "0", 0 },
                                { "2:subband5gver", "0x4", 0 },
                                { "2:mcsbw1605gmpo", "0", 0 },
                                { "2:mcsbw205gmpo", "0x87657530", 0 },
                                { "2:mcslr5gmpo", "0", 0 },
                                { "2:femctrl", "6", 0 },
                                { "2:aa5g", "7", 0 },
                                { "2:maxp5ga0", "90,90,90,90", 0 },
                                { "2:maxp5ga1", "90,90,90,90", 0 },
                                { "2:maxp5ga2", "90,90,90,90", 0 },
                                { "2:antswitch", "0", 0 },
                                ...
                                { "2:tempsense_slope", "0xff", 0 },
                                { "2:mcsbw1605glpo", "0", 0 },
                                { "2:mcsbw205glpo", "0x87657530", 0 },
                                { "2:tworangetssi5g", "0", 0 },
                                { "2:temps_period", "5", 0 },
                                { "2:mcslr5glpo", "0", 0 },
                                { "2:mcsbw1605ghpo", "0", 0 },
                                { "2:boardrev", "0x1421", 0 },
                                { "2:rpcal5gb0", "0x3739", 0 },
                                { "2:mcsbw805gmpo", "0x87657531", 0 },
                                { "2:rpcal5gb1", "0", 0 },
                                { "2:rpcal5gb2", "0", 0 },
                                { "2:rpcal5gb3", "0", 0 },
                                { "2:mcsbw205ghpo", "0x87657530", 0 },
                                { "2:mcslr5ghpo", "0", 0 },
                                { "2:devpath2", "sb/1/", 0 },
                                { "2:boardvendor", "0x14e4", 0 },
                                { "2:temps_hysteresis", "5", 0 },
